 ...
 */
public class ProdGUI extends JFrame {
	...
	private static ProdGUI obj=null;
	
	String sPTNO,sQty,sID_Operator;
	int iShift;
	
	Integer[] shiftArray = new Integer[] {0,1,2,3};
	String[] defectArray = new String[] {NONE,"ASTILLADA", "MANCHADA","CONTAMINADA", "INCOMPLETA", "QUEMADA", "POROSA","RECHUPE","PARCHOS","PARTIDA","BURBUJA","RAYADA"};
	...
	public ProdGUI()  {
		...
		JLabel lblTitle1 = new JLabel("Production Report");
		lblTitle1.setForeground(SystemColor.text);
		
		lblTitle1.setBounds(248, 38, 223, 30);
		...
		btnSubmit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                else if(!FileHandler.PTNOCheck(sPTNO,DatabaseConn.getAREA()) || sPTNO.equals(""))
                {
                 JOptionPane.showMessageDialog(null,"Error: Enter a valid part number. / Entre un número de pieza valido.");                	
                	...
                	if (JOptionPane.showConfirmDialog(null, "Are you sure? / ¿Esta seguro de los datos?", "WARNING",
                		...
                		DatabaseConn.dbProdInput(sPTNO,sID_Operator,iShift,sQty);
